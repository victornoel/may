...
(
    ...
    { 
        $current = $this_Ecosystem_0.current; 
        afterParserOrEnumRuleCall();
    }
...
(
    ...
    { 
        $current = $this_ComponentPart_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_SpeciesPart_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleEcosystem returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getEcosystemRule()); }
	 iv_ruleEcosystem=ruleEcosystem 
	 { $current=$iv_ruleEcosystem.current; } 
	 EOF 
;

// Rule Ecosystem
ruleEcosystem returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='ecosystem' 
...
entryRuleComponentPart returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getComponentPartRule()); }
	 iv_ruleComponentPart=ruleComponentPart 
	 { $current=$iv_ruleComponentPart.current; } 
	 EOF 
;

// Rule ComponentPart
ruleComponentPart returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='part' 
...
entryRuleSpeciesPart returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSpeciesPartRule()); }
	 iv_ruleSpeciesPart=ruleSpeciesPart 
	 { $current=$iv_ruleSpeciesPart.current; } 
	 EOF 
;

// Rule SpeciesPart
ruleSpeciesPart returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='use' 
...
entryRuleSpeciesReference returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSpeciesReferenceRule()); }
	 iv_ruleSpeciesReference=ruleSpeciesReference 
	 { $current=$iv_ruleSpeciesReference.current; } 
	 EOF 
;

// Rule SpeciesReference
ruleSpeciesReference returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
    ...
    {
    	newLeafNode(otherlv_9, grammarAccess.getJvmParameterizedTypeReferenceAccess().getLeftSquareBracketKeyword_1_4_2_0());
    }
)(
(
		{ 
...
(
    ...
    {
    	newLeafNode(otherlv_13, grammarAccess.getJvmParameterizedTypeReferenceAccess().getRightSquareBracketKeyword_1_4_2_3());
    }
)?)*)?)
;
