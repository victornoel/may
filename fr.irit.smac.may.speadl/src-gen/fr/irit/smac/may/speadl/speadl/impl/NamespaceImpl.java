...
public class NamespaceImpl extends ModelElementImpl implements Namespace
{
  ...
  {
    return SpeadlPackage.Literals.NAMESPACE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpeadlPackage.NAMESPACE__NAME, oldName, name));
  }
  ...
  public EList<ModelElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<ModelElement>(ModelElement.class, this, SpeadlPackage.NAMESPACE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SpeadlPackage.NAMESPACE__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpeadlPackage.NAMESPACE__NAME:
        return getName();
      case SpeadlPackage.NAMESPACE__ELEMENTS:
        return getElements();
    }
