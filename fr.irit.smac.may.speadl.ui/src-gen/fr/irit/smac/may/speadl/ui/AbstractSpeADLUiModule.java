...
/**
 * Manual modifications go to {fr.irit.smac.may.speadl.ui.SpeADLUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractSpeADLUiModule extends org.eclipse.xtext.xbase.ui.DefaultXbaseUiModule {
	
	public AbstractSpeADLUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(fr.irit.smac.may.speadl.parser.antlr.internal.InternalSpeADLLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return fr.irit.smac.may.speadl.ui.labeling.SpeADLLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(fr.irit.smac.may.speadl.ui.labeling.SpeADLDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return fr.irit.smac.may.speadl.ui.outline.SpeADLOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return fr.irit.smac.may.speadl.ui.quickfix.SpeADLQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.ContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return fr.irit.smac.may.speadl.ui.contentassist.SpeADLProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return fr.irit.smac.may.speadl.ui.contentassist.antlr.SpeADLParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(fr.irit.smac.may.speadl.ui.contentassist.antlr.internal.InternalSpeADLLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(fr.irit.smac.may.speadl.ui.contentassist.antlr.internal.InternalSpeADLLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(fr.irit.smac.may.speadl.ui.contentassist.antlr.internal.InternalSpeADLLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.codetemplates.ui.partialEditing.IPartialContentAssistParser> bindIPartialContentAssistParser() {
		return fr.irit.smac.may.speadl.ui.contentassist.antlr.PartialSpeADLContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(com.google.inject.Binder binder) {
		binder.bind(String.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.UIBindings.COMPARE_VIEWER_TITLE)).toInstance("SpeADL Compare");
	}
