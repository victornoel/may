...
* generated by Xtext
*/
package fr.irit.smac.may.speadl.ui.contentassist.antlr;
...
public class SpeADLParser extends AbstractContentAssistParser {
	...
	@Override
	protected fr.irit.smac.may.speadl.ui.contentassist.antlr.internal.InternalSpeADLParser createParser() {
		fr.irit.smac.may.speadl.ui.contentassist.antlr.internal.InternalSpeADLParser result = new fr.irit.smac.may.speadl.ui.contentassist.antlr.internal.InternalSpeADLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEcosystemAccess().getAlternatives_6(), "rule__Ecosystem__Alternatives_6");
					put(grammarAccess.getComponentAccess().getAlternatives_6(), "rule__Component__Alternatives_6");
					put(grammarAccess.getSpeciesAccess().getAlternatives_4(), "rule__Species__Alternatives_4");
					...
					put(grammarAccess.getFakeAbstractComponentAccess().getGroup(), "rule__FakeAbstractComponent__Group__0");
					put(grammarAccess.getFeatureAccess().getGroup(), "rule__Feature__Group__0");
					put(grammarAccess.getImplementedByAccess().getGroup(), "rule__ImplementedBy__Group__0");
					put(grammarAccess.getEcosystemAccess().getGroup(), "rule__Ecosystem__Group__0");
					put(grammarAccess.getEcosystemAccess().getGroup_2(), "rule__Ecosystem__Group_2__0");
					put(grammarAccess.getEcosystemAccess().getGroup_2_2(), "rule__Ecosystem__Group_2_2__0");
					put(grammarAccess.getEcosystemAccess().getGroup_3(), "rule__Ecosystem__Group_3__0");
					...
					put(grammarAccess.getComponentAccess().getGroup_2_2(), "rule__Component__Group_2_2__0");
					put(grammarAccess.getComponentAccess().getGroup_3(), "rule__Component__Group_3__0");
					put(grammarAccess.getSpeciesAccess().getGroup(), "rule__Species__Group__0");
					put(grammarAccess.getSpeciesAccess().getGroup_2(), "rule__Species__Group_2__0");
					put(grammarAccess.getSpeciesAccess().getGroup_2_1(), "rule__Species__Group_2_1__0");
					put(grammarAccess.getSpeciesAccess().getGroup_2_1_1(), "rule__Species__Group_2_1_1__0");
					put(grammarAccess.getProvidedPortAccess().getGroup(), "rule__ProvidedPort__Group__0");
					put(grammarAccess.getProvidedPortAccess().getGroup_4(), "rule__ProvidedPort__Group_4__0");
					put(grammarAccess.getRequiredPortAccess().getGroup(), "rule__RequiredPort__Group__0");
					put(grammarAccess.getComponentPartAccess().getGroup(), "rule__ComponentPart__Group__0");
					put(grammarAccess.getComponentPartAccess().getGroup_4(), "rule__ComponentPart__Group_4__0");
					put(grammarAccess.getSpeciesPartAccess().getGroup(), "rule__SpeciesPart__Group__0");
					...
					put(grammarAccess.getSpeciesReferenceAccess().getGroup_3_1_1(), "rule__SpeciesReference__Group_3_1_1__0");
					...
					put(grammarAccess.getNamespaceAccess().getElementsAssignment_3(), "rule__Namespace__ElementsAssignment_3");
					put(grammarAccess.getFakeAbstractComponentAccess().getNameAssignment_0(), "rule__FakeAbstractComponent__NameAssignment_0");
					put(grammarAccess.getFakeAbstractComponentAccess().getParametersAssignment_1(), "rule__FakeAbstractComponent__ParametersAssignment_1");
					put(grammarAccess.getFakeAbstractComponentAccess().getTypeParametersAssignment_2(), "rule__FakeAbstractComponent__TypeParametersAssignment_2");
					put(grammarAccess.getFakeAbstractComponentAccess().getSpecializesAssignment_3(), "rule__FakeAbstractComponent__SpecializesAssignment_3");
					put(grammarAccess.getFakeAbstractComponentAccess().getProvidesAssignment_4(), "rule__FakeAbstractComponent__ProvidesAssignment_4");
					put(grammarAccess.getFakeAbstractComponentAccess().getRequiresAssignment_5(), "rule__FakeAbstractComponent__RequiresAssignment_5");
					put(grammarAccess.getFakeAbstractComponentAccess().getPartsAssignment_6(), "rule__FakeAbstractComponent__PartsAssignment_6");
					put(grammarAccess.getFakeAbstractComponentAccess().getSpeciesAssignment_7(), "rule__FakeAbstractComponent__SpeciesAssignment_7");
					put(grammarAccess.getFakeAbstractPortAccess().getTypeReferenceAssignment(), "rule__FakeAbstractPort__TypeReferenceAssignment");
					put(grammarAccess.getFakeContentElementAccess().getNameAssignment(), "rule__FakeContentElement__NameAssignment");
					put(grammarAccess.getFakePartAccess().getBindingsAssignment(), "rule__FakePart__BindingsAssignment");
					put(grammarAccess.getFeatureAccess().getNameAssignment_0(), "rule__Feature__NameAssignment_0");
					put(grammarAccess.getFeatureAccess().getParameterTypeAssignment_2(), "rule__Feature__ParameterTypeAssignment_2");
					put(grammarAccess.getImplementedByAccess().getRefAssignment_1(), "rule__ImplementedBy__RefAssignment_1");
					put(grammarAccess.getEcosystemAccess().getNameAssignment_1(), "rule__Ecosystem__NameAssignment_1");
					put(grammarAccess.getEcosystemAccess().getTypeParametersAssignment_2_1(), "rule__Ecosystem__TypeParametersAssignment_2_1");
					put(grammarAccess.getEcosystemAccess().getTypeParametersAssignment_2_2_1(), "rule__Ecosystem__TypeParametersAssignment_2_2_1");
					put(grammarAccess.getEcosystemAccess().getSpecializesAssignment_3_1(), "rule__Ecosystem__SpecializesAssignment_3_1");
					put(grammarAccess.getEcosystemAccess().getImplementedByAssignment_4(), "rule__Ecosystem__ImplementedByAssignment_4");
					put(grammarAccess.getEcosystemAccess().getProvidesAssignment_6_0(), "rule__Ecosystem__ProvidesAssignment_6_0");
					put(grammarAccess.getEcosystemAccess().getRequiresAssignment_6_1(), "rule__Ecosystem__RequiresAssignment_6_1");
					put(grammarAccess.getEcosystemAccess().getPartsAssignment_6_2(), "rule__Ecosystem__PartsAssignment_6_2");
					put(grammarAccess.getEcosystemAccess().getSpeciesAssignment_6_3(), "rule__Ecosystem__SpeciesAssignment_6_3");
					put(grammarAccess.getComponentAccess().getNameAssignment_1(), "rule__Component__NameAssignment_1");
					put(grammarAccess.getComponentAccess().getTypeParametersAssignment_2_1(), "rule__Component__TypeParametersAssignment_2_1");
					put(grammarAccess.getComponentAccess().getTypeParametersAssignment_2_2_1(), "rule__Component__TypeParametersAssignment_2_2_1");
					put(grammarAccess.getComponentAccess().getSpecializesAssignment_3_1(), "rule__Component__SpecializesAssignment_3_1");
					put(grammarAccess.getComponentAccess().getImplementedByAssignment_4(), "rule__Component__ImplementedByAssignment_4");
					put(grammarAccess.getComponentAccess().getProvidesAssignment_6_0(), "rule__Component__ProvidesAssignment_6_0");
					put(grammarAccess.getComponentAccess().getRequiresAssignment_6_1(), "rule__Component__RequiresAssignment_6_1");
					put(grammarAccess.getComponentAccess().getPartsAssignment_6_2(), "rule__Component__PartsAssignment_6_2");
					put(grammarAccess.getSpeciesAccess().getNameAssignment_1(), "rule__Species__NameAssignment_1");
					put(grammarAccess.getSpeciesAccess().getParametersAssignment_2_1_0(), "rule__Species__ParametersAssignment_2_1_0");
					put(grammarAccess.getSpeciesAccess().getParametersAssignment_2_1_1_1(), "rule__Species__ParametersAssignment_2_1_1_1");
					put(grammarAccess.getSpeciesAccess().getProvidesAssignment_4_0(), "rule__Species__ProvidesAssignment_4_0");
					put(grammarAccess.getSpeciesAccess().getRequiresAssignment_4_1(), "rule__Species__RequiresAssignment_4_1");
					put(grammarAccess.getSpeciesAccess().getPartsAssignment_4_2(), "rule__Species__PartsAssignment_4_2");
					put(grammarAccess.getProvidedPortAccess().getNameAssignment_1(), "rule__ProvidedPort__NameAssignment_1");
					put(grammarAccess.getProvidedPortAccess().getTypeReferenceAssignment_3(), "rule__ProvidedPort__TypeReferenceAssignment_3");
					put(grammarAccess.getProvidedPortAccess().getBoundAssignment_4_1(), "rule__ProvidedPort__BoundAssignment_4_1");
					put(grammarAccess.getRequiredPortAccess().getNameAssignment_1(), "rule__RequiredPort__NameAssignment_1");
					put(grammarAccess.getRequiredPortAccess().getTypeReferenceAssignment_3(), "rule__RequiredPort__TypeReferenceAssignment_3");
					put(grammarAccess.getComponentPartAccess().getNameAssignment_1(), "rule__ComponentPart__NameAssignment_1");
					put(grammarAccess.getComponentPartAccess().getComponentReferenceAssignment_3(), "rule__ComponentPart__ComponentReferenceAssignment_3");
					put(grammarAccess.getComponentPartAccess().getBindingsAssignment_4_1(), "rule__ComponentPart__BindingsAssignment_4_1");
					put(grammarAccess.getSpeciesPartAccess().getNameAssignment_1(), "rule__SpeciesPart__NameAssignment_1");
					put(grammarAccess.getSpeciesPartAccess().getSpeciesReferenceAssignment_3(), "rule__SpeciesPart__SpeciesReferenceAssignment_3");
					...
					put(grammarAccess.getSpeciesReferenceAccess().getArgumentsAssignment_3_1_1_1(), "rule__SpeciesReference__ArgumentsAssignment_3_1_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			fr.irit.smac.may.speadl.ui.contentassist.antlr.internal.InternalSpeADLParser typedParser = (fr.irit.smac.may.speadl.ui.contentassist.antlr.internal.InternalSpeADLParser) parser;
